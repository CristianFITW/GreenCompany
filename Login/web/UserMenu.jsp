...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/UserDesigns.css" type="text/css" media="all">
    ...
    <body>
        ...
        <div class="tarjeta">
            <ul class="lista">
                ...
                <%-- Verificamos si el nombre del usuario es null --%>
                <%
                ...
                %>
                    <li class="elemento">
                        <svg class="lucide lucide-usuario-redondo-agregar"
                            ...
                            <path d="M15 3H16.2C17.8802 3 18.7202 3 19.362 3.32698C19.9265 3.6146 20.3854 4.07354 20.673 4.63803C21 5.27976 21 6.11985 21 7.8V16.2C21 17.8802 21 18.7202 20.673 19.362C20.3854 19.9265 19.9265 20.3854 19.362 20.673C18.7202 21 17.8802 21 16.2 21H15M10 12H21M21 12L18 15M21 12L18 9"></path>
                        </svg>
                        <p class="etiqueta" onclick="cargarLogin()">Iniciar Sesión</p>
                    </li>
                    <li class="elemento">
                        <svg class="lucide lucide-ajustes"
                            stroke-linejoin="round"
                            stroke-linecap="round"
                            stroke-width="2"
                            stroke="#7e8590"
                            ...
                            width="24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M3,17H7M5,19V15"></path>
                            <path id="primary" d="M9,21H20a1,1,0,0,0,1-1,7,7,0,0,0-7-7H12a6.91,6.91,0,0,0-2,.29" ></path>
                            <circle id="primary-2" data-name="primary" cx="13" cy="8" r="5" ></circle>
                        </svg>
                ...
                <% } else { %>
                    <li class="elemento">
                      ...
                      <p class="etiqueta" onclick="window.location.href='paginaInicio.jsp'"><%=request.getSession().getAttribute("nombre") %></p>
                    </li>
                    <%-- Si el nombre no es null, mostramos las demás opciones --%>
