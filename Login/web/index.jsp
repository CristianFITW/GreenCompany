...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/prov.css" type="text/css" media="all">
    </head>
    <body>
...
<figure id="welcomeMessage">
  <figcaption>
    <h1>
      ...
      <b>
        M
        <a href="indexmapa.jsp" title="Mapa CDMX">
          <svg class="unique-svg" xmlns="http://www.w3.org/2000/svg&quot; id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
  <path d="m15.888,1.611c-1.039-1.039-2.419-1.611-3.888-1.611s-2.851.572-3.888,1.611c-1.04,1.038-1.612,2.419-1.612,3.889s.576,2.854,1.649,3.926l3.851,3.572,3.888-3.609c1.04-1.038,1.612-2.419,1.612-3.889s-.572-2.851-1.612-3.889Zm-3.888,5.395c-.828,0-1.5-.672-1.5-1.5s.672-1.5,1.5-1.5,1.5.672,1.5,1.5-.672,1.5-1.5,1.5ZM1.74,11.632l.502-3.109c.199-1.232,1.118-2.171,2.287-2.438.139,1.787.911,3.463,2.26,4.807l5.212,4.835,5.301-4.923c1.279-1.277,2.033-2.935,2.17-4.719,1.169.267,2.088,1.206,2.287,2.438l.841,5.243-12.214,5.552L1.74,11.632Zm21.187,4.18l1.073,6.688v1.5h-8.346l-3.634-3.23,10.907-4.958Zm-10.284,8.188H0l.013-1.659,1.35-8.369,11.281,10.028Z"/>
      ...
      <b>
        E
        <a href="Pages/index_GreenCompany.html" title="Green Company">
          <svg class="unique-svg" xmlns="http://www.w3.org/2000/svg&quot; id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
      ...
      <b>
        N
        <a href="Pages/EcoWorld.jsp" title="Minijuegos">
          <svg class="unique-svg" xmlns="http://www.w3.org/2000/svg&quot; id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
            <path d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0ZM22,12a9.941,9.941,0,0,1-1.646,5.482A5.288,5.288,0,0,1,19,13.99V12H13a1,1,0,0,1-1-1V10h3V6h2.914l1.109-1.109A9.969,9.969,0,0,1,22,12Zm-19.951.963L6.086,17H10a1,1,0,0,1,1,1v3.949A10.016,10.016,0,0,1,2.049,12.963ZM13,21.949V18a3,3,0,0,0-3-3H6.914L2.163,10.249A9.978,9.978,0,0,1,17.456,3.63l-.37.37H13V8H10v3a3,3,0,0,0,3,3h4a7.2,7.2,0,0,0,2.072,5.063A9.969,9.969,0,0,1,13,21.949Z"/>
          </svg>
        </a>
      </b>
      <b>
        Ú
        <a href="javascript:void(0);" title="Proximamente">
<svg class="unique-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" viewBox="0 0 32 32" xml:space="preserve">
      ...
      <b>
          ...
          <svg class="unique-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
      ...
      <b>
          ...
          <svg class="unique-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px"><path d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z"/></svg>
        <a href="javascript:void(0);" title="Facebook" onclick="document.getElementById('toggleClose').click();">
          <svg class="unique-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px"><path d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z"/></svg>
        </a>
      </b>
    </h1>
...
<style>
#menuUsuario {
  position: relative; /* Asegura que el menú se relacione con este elemento */
}

#menuUsuarioContainer {
  position: absolute;
  top: 110%; /* Baja el menú un poco más */
  left: 50%; /* Coloca el menú en el centro horizontalmente */
  transform: translateX(-50%); /* Ajusta para centrarlo completamente */
  background-color: #ffffff00; /* Fondo transparente o color deseado */
  z-index: 100; /* Asegura que se muestre encima de otros elementos */
  padding: 10px; /* Opcional: Ajusta el espacio interno si es necesario */
}
...
$(document).ready(function () {
    // Añadimos el evento global al cargar la página
    $(document).on('click', function (event) {
        cerrarMenuFuera(event);
    });
});

function cargarMenuUsuario() {
    const menu = $('#menuUsuarioContainer');
    if (menu.is(':visible')) {
        menu.hide(); // Si el menú ya está visible, lo ocultamos
    } else {
        // Cargamos el contenido del menú
        $.ajax({
            url: 'UserMenu.jsp',
            type: 'GET',
            success: function (response) {
                // Mostrar el contenido de UserMenu.jsp dentro del contenedor
                menu.html(response).show(); // Mostrar y actualizar el menú
            },
            error: function () {
...
function cerrarMenuFuera(event) {
    const menu = $('#menuUsuarioContainer');
    const boton = $('#menuUsuario');

    // Verifica si el clic fue fuera del menú y del botón
    if (!menu.is(event.target) && menu.has(event.target).length === 0 &&
        !boton.is(event.target) && boton.has(event.target).length === 0) {
