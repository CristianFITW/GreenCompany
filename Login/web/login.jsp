...
<html>
    ...
    <body>
        ...
        <div class="card">
            <div class="card2">
                <form class="form" id="formularioLogin" method="post" action="InicioSesionServlet">
                    <p id="heading">Inicie Sesion</p>
                    ...
                    <div class="field">
                        ...
                        <input type="text" class="input-field" placeholder="Usuario" required name="txtUsuario" autocomplete="off"/>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input type="password" class="input-field" placeholder="Contraseña" required name="txtContrasena"/>
                    </div>

                    <div class="btn">
                        <button type="submit" class="button1">Iniciar Sesion</button>
                        <button type="button" class="button2" onclick="resetearFormularioLogin()">Borrar Datos</button>
                    </div>
